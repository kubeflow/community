...
This file is the template applicants populate when proposing a new Kubeflow subproject.
To apply, copy this file to `subprojects/<issue-number>-<project-name>/README.md`.

Leave a field blank only if it is genuinely not applicable; if so, briefly note why.
The Kubeflow Steering Committee uses the populated form as the primary input for its decision,
so the more complete and specific your answers, the smoother the review.
...
1. ## Project Name
1. ## Why is this project valuable to the Kubeflow Community?
...
1. ## Adoption
1. ## License Agreement
1. ## Part of an Open Source Foundation? (e.g., Apache, Linux, CNCF, etc.)
1. ## Vendor Neutrality
