...
### Establish Kubeflow Distribution Committee
...
Kubeflow has grown into an ecosystem of independent sub-projects and a community distribution that integrates them, with no dedicated vendor-neutral body governing their consumability, conformance, and distribution.

#### Decision

We will establish the Kubeflow Distribution Committee (KDC) as defined in [`committee-distribution/charter.md`](../committee-distribution/charter.md).

#### Rationale

- A dedicated, vendor-neutral committee gives sub-project consumability, the conformance program, and the community distribution a clear and accountable owner.
