...
## Non-Goals
* Deep integration with hyperscalers such as AWS managed databases but for example basic Dex/oauth2-proxy configuration for authentication integration is a goal.
