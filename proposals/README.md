...
<!-- toc -->
- [KEP Format to Propose and Document Enhancements to Kubeflow](#kep-format-to-propose-and-document-enhancements-to-kubeflow)
  - [Summary](#summary)
...
A standardized development process for Kubeflow is proposed, in order to:
...
We are proposing usage of KEPs in Kubeflow to be better aligne with the wider Kubernetes community.
...
for maintainers to deliberate. Contributors proposing new KEPs should create a copy of the [template directory](./NNNN-template)
and proceed as per the instructions in the template.
